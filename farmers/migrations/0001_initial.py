...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'farmers_crop', (
            ...
            ('estimated_vol', self.gf('django.db.models.fields.DecimalField')(default='', null=True, max_digits=10, decimal_places=2)),
        ...
        # Adding model 'Livestock'
        db.create_table(u'farmers_livestock', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('livestock_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
            ('count', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True)),
            ('capacity', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True)),
            ('stage', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True)),
            ('farm', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['farmers.Farm'])),
        ))
        db.send_create_signal(u'farmers', ['Livestock'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Livestock'
        db.delete_table(u'farmers_livestock')
